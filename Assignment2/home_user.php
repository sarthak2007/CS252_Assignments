...
<div class="w3-top">
 <div class="w3-bar w3-theme-d5 w3-left-align w3-large" style="background-color:black">
  ...
  <a href="applied.php" class="w3-bar-item w3-button w3-hover-white w3-padding-large w3-theme-d5"><i class="fa fa-check w3-margin-right"></i>APPLIED JOBS</a>
...
<form align="center" method="post" action="query_user.php">
 <br>
...
<br><br>
 ...
 <br><br><br>
    ...
    <!-- Left Column -->
    <div class="w3-col m3" style='width: 24%;margin-left:2%;right:7%;margin-top:-16%;' >
      <!-- Profile -->
	...
	if ($conn->connect_error) {
		...
		if ($result->num_rows > 0) {
		    ...
		    while($row = $result->fetch_assoc()) {
				...
				";
				echo "<div class='card' align='left' style='width: 63%;margin-right:-22%;right:7%;'>
