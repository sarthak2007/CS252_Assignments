...
<br>
<div class="w3-col m3" style='width: 20%;margin-left:2%;right:7%;margin-top:1%;' >
      <!-- Profile -->
	...
	if ($conn->connect_error) {
		...
		if ($result->num_rows > 0) {
		    ...
		    while($row = $result->fetch_assoc()) {
				...
				";
				echo "<div class='card'  id='a".$row["ID"]."' align='left' style='width: 60%;margin-right:-20%;right:7%;'>
